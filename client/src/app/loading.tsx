  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-16">
        <div className="bg-slate-200 py-12 sm:py-24 rounded-2xl sm:rounded-3xl mt-4 sm:mt-6 mb-6 sm:mb-8 animate-pulse">
          <div className="max-w-7xl mx-auto px-4 text-center">
            <div className="h-10 sm:h-16 w-3/4 bg-slate-300 rounded-xl mx-auto mb-6" />
            <div className="h-5 sm:h-6 w-2/3 bg-slate-300 rounded-lg mx-auto mb-8" />
            <div className="flex gap-4 justify-center mb-12">
              <div className="h-12 w-36 sm:w-44 bg-slate-300 rounded-xl" />
              <div className="h-12 w-36 sm:w-44 bg-slate-300 rounded-xl" />
            </div>
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2 sm:gap-3 max-w-5xl mx-auto">
              {Array.from({ length: 5 }).map((_, i) => (
                <div key={i} className="h-24 sm:h-32 bg-slate-300 rounded-xl" />
              ))}
            </div>
          </div>
        </div>
