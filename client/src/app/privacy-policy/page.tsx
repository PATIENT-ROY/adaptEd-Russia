          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <p className="text-gray-700">
                ...
                Политики. Отдельное согласие на обработку персональных данных
                предоставляется через документ{" "}
                <a
                ...
                и отметку на соответствующих формах сайта (галочка не
                устанавливается автоматически) в соответствии с Федеральным
                законом &ldquo;О персональных данных&rdquo; от 27.07.2006 N
                152-ФЗ.
              </p>
            </CardContent>
          </Card>
