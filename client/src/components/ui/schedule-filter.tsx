        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              >
                <option value="group">{t("schedulePage.kind.group")}</option>
                <option value="teacher">
                  {t("schedulePage.kind.teacher")}
                </option>
                <option value="room">{t("schedulePage.kind.room")}</option>
              </select>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <select className="text-sm border-none bg-transparent focus:ring-0">
                  <option>{t("schedulePage.pair.current")}</option>
                  <option>{t("schedulePage.pair.next")}</option>
                  <option>{t("schedulePage.pair.previous")}</option>
                </select>
              </div>
            </div>
          </div>
